        ...
        return (
          ...
          >
            <a
              href="#services"
              className={cn(
                "group glass-panel flex h-full flex-col rounded-2xl p-4 transition duration-300 sm:p-5",
            ...
            >
              ...
              <h3 className="mt-4 text-sm font-semibold tracking-tight text-ink sm:text-base">
                {service.title}
              </h3>
